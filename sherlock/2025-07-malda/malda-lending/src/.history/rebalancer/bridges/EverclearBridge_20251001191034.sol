...
contract EverclearBridge is BaseBridge, IBridge {
    ...
    function sendMsg(
        ...
        //~ @audit-medium Issue H-1: Rebalancer can steal funds from markets by sending to custom receiver through Everclear Bridge 
        //~ CCC calldata 内容未被检查
        ...
        //~ @audit-medium NOTE: Issue M-5: Rebalancer can send to unallowed destination chains through EverclearBridge
        ...
        //~ @audit-medium NOTE: Issue M-6: EverclearBridge does not pull tokens from the Rebalancer, causing all rebalancing operations to fail

        //~ mitigation: pull tokens from the Rebalancer before creating the intent
