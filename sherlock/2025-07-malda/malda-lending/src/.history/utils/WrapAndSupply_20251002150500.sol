...
contract WrapAndSupply {
        ...
        payable
    {
        ...
        //~ @audit-M NOTE: Issue M-13: gasFee is not reserved in wrapAndSupplyOnExtensionMarket
        //~ Host 跨链操作（supplyOnHost）：除了本链 gas，还要支付额外的 gasFee，用于消息跨链传输 & 在 host 上执行 mintExternal 的费用
