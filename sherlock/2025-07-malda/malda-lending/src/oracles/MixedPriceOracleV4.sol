...
contract MixedPriceOracleV4 is IOracleOperator {
        ...
        returns (uint256, uint256)
    {
        ...
        //~ @audit-M Issue M-14: API3 and EO oracles return prices using different decimals
        //~ API3 Oracle：价格始终用 18 decimals（比如 1 BTC = 12000 USD，会返回 12000 * 1e18）。
        //~ EO Oracle：通常用 8 decimals（同样的价格会返回 12000 * 1e8）。
