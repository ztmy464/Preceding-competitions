...
contract FeeAuction is IFeeAuction, UUPSUpgradeable, Access, FeeAuctionStorageUtils {
    ...
    lender repy realizeinterest                       -> feeAucrion.buy (collateral -> cUSD) -> FeeReceiver.distribute -> stakedCap (linear unlock the profit in eatch lockDuration)
    FractionalReserve withdraw interest from ERC4626  -> 
    /// @inheritdoc IFeeAuction
    function buy(
        uint256 _maxPrice,
